...
class SolarSystem final {
 public:
  ...
  // local origin (see the constructor of `Ephemeris`).  If the clustering
  // produced multiple subsystems, `far_field_damping_floor` is passed on to
  // the ephemeris to damp the far field seen by massless bodies.
