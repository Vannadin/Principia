...
class MockEphemeris : public Ephemeris<Frame> {
 public:
  ...
  MOCK_METHOD(Displacement<Frame>,
  ...
  MOCK_METHOD(Velocity<Frame>,
              ...
              (int s1, int s2),
              (const, override));
  MOCK_METHOD((std::pair<Displacement<Frame>, Velocity<Frame>>),
              placement_conversion,
              (typename Ephemeris<Frame>::SubsystemPlacement const& from,
               typename Ephemeris<Frame>::SubsystemPlacement const& to,
               Instant const& t),
              (const, override));
  ...
  MOCK_METHOD(Position<Frame>,
              subsystem_barycentre,
              (int s, Instant const& t),
              (const, override));
